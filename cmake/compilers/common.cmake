...
# Enabling LTO
set(TBB_COMMON_COMPILE_FLAGS ${TBB_COMMON_COMPILE_FLAGS} ${TBB_IPO_COMPILE_FLAG})
set(TBB_COMMON_LINK_FLAGS ${TBB_COMMON_LINK_FLAGS} ${TBB_IPO_LINK_FLAG})
if (WIN32)
    set(TBB_COMMON_LINK_FLAGS ${TBB_COMMON_LINK_FLAGS} /INCREMENTAL:NO)
endif()
